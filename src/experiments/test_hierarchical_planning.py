#!/usr/bin/env python3
"""
Test Hierarchical Planning with Trained 3-Level RGM.

This script tests goal-directed planning using the hierarchical model:
...
def main():
    ...
    parser.add_argument('--output_dir', type=str, default='outputs/hierarchical_planning_test',
