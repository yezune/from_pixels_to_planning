#!/usr/bin/env python3
"""
Train 3-Level Hierarchical RGM on Atari Pong.

This script implements full hierarchical training for Pong with:
...
Training Strategy:
1. Load pre-trained Level 0 VAE (from train_pong_vae.py)
...
Usage:
    ...
    # Quick test
    python src/experiments/train_pong_hierarchical.py \
        --level0_vae_path outputs/pong_vae_quick_test/best_model.pt \
        --num_episodes 10 \
        --output_dir outputs/pong_hierarchical_quick_test
"""
...
def main():
    ...
    parser.add_argument('--output_dir', type=str, default='outputs/pong_hierarchical_training',
                       help='Output directory (default: outputs/pong_hierarchical_training)')
